...
> **Migration note**: 本 spec は `docs/wbs/2026-04-25-feature-86-p5a-expansion-iter1.md` から spec 化 (Global CLAUDE.md §Documentation Structure 準拠の `docs/wbs/` 廃止対応、2026-05-05)。
