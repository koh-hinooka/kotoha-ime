...
> **Migration note**: 本 spec は `docs/wbs/2026-04-26-feature-105-p2-c-learning-cache.md` から spec 化 (Global CLAUDE.md §Documentation Structure 準拠の `docs/wbs/` 廃止対応、2026-05-05)。
