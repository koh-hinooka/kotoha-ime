...
> **Migration note**: 本 spec は `docs/wbs/2026-04-23-docs-36-adr-count-narrative.md` から spec 化 (Global CLAUDE.md §Documentation Structure 準拠の `docs/wbs/` 廃止対応、2026-05-05)。
